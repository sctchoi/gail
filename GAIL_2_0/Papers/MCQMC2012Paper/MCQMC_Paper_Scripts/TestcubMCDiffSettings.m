...
% save(['TestcubMCon-' fun.funtype '-' param.measure '-Out-' timestamp 'N' ...
%     int2str(test.nrep) 'd' int2str(param.dim)  ...
%     'tol' num2str(param.tol) '.mat'])
save([path, 'TestcubMCon-' fun.funtype '-' param.measure '-Out-' ...
    timestamp 'N' int2str(test.nrep) 'd' int2str(param.dim)  ...
    'tol' num2str(param.tol) '.mat'])
% save(['TestcubMCon-' fun.funtype '-' param.measure '-Out-' ...
%     timestamp 'N' int2str(test.nrep) 'd' int2str(param.dim)  ...
%     'tol' num2str(param.tol) '.mat']) 
