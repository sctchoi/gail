...
% Files
%   UniFunMin_Plot_Bump   
%           - Generate Figure 3.1 in the thesis using a=0.03 and z=0.4 to
%             construct an example of the bump test functions.
%   UniFunMin_Plot_TwoExtreme 
%           - Generate Figure 3.2 in the thesis using a1=0.3 and a2=0.75
%             to construct a function with two local minimum points.
%   UniFunMin_Plot_Flat 
